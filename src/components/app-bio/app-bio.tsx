  ...
  render() {
      return (
        <div class="container pt-5">
          <div class="row body">
            <div class="col mx-3 body-img"></div>
            <div class="col bio p-5">
              ...
              <p class="bio">
                Jedi (Jedidiah) Weller is CO-CEO & Head of Technology at <a href="www.webjunto.com"> Webjunto </a>, a Design & Development agency providing customized services across the globe. 
                In addition, Jedi is an entrepreneur, landlord, dog lover, and organizer of the <a href="https://www.meetup.com/phillyjunto/"> Philadelphia Junto </a>, one of the fastest growing meetups in Philly. 
              </p>
              <p class="bio">
